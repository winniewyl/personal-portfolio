  ...
  return (
    <div className="w-full">
      ...
      <div className="relative bg-white dark:bg-[#232336] rounded-xl shadow-lg p-4 sm:p-6 w-full max-w-4xl mx-auto">
        ...
        <div className="w-96 sm:w-[500px] md:w-[600px] mx-auto h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700" style={{ maxWidth: '600px' }}>
          {isMapLoaded && L ? (
            <MapContainer
              center={[20, 0]}
              zoom={2}
