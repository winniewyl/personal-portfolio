...
const About: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 lg:mb-10 text-blue-600 dark:text-blue-400">
        About Me
      </h2>
      ...
      <div className="relative bg-white dark:bg-[#232336] rounded-xl shadow-lg p-4 sm:p-6 w-full">
        ...
        <div className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
          {isMapLoaded && L ? (
            <MapContainer
              center={[20, 0]}
              zoom={2}
