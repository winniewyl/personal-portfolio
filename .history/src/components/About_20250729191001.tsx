          ...
          <div className="relative w-full h-96 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <div className="absolute inset-0">
              <svg viewBox="0 0 1000 500" className="w-full h-full">
                {/* North America */}
                <path
                  d="M120,120 Q150,80 180,120 T240,120 L240,200 Q210,240 180,200 T120,200 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M140,180 Q170,140 200,180 T260,180 L260,220 Q230,260 200,220 T140,220 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M160,200 Q190,160 220,200 T280,200 L280,240 Q250,280 220,240 T160,240 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* South America */}
                <path
                  d="M200,220 Q230,180 260,220 T320,220 L320,380 Q290,420 260,380 T200,380 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M220,240 Q250,200 280,240 T340,240 L340,360 Q310,400 280,360 T220,360 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Europe */}
                <path
                  d="M480,80 Q510,40 540,80 T600,80 L600,160 Q570,200 540,160 T480,160 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M500,100 Q530,60 560,100 T620,100 L620,140 Q590,180 560,140 T500,140 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M520,120 Q550,80 580,120 T640,120 L640,160 Q610,200 580,160 T520,160 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Africa */}
                <path
                  d="M480,160 Q510,120 540,160 T600,160 L600,320 Q570,360 540,320 T480,320 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M500,180 Q530,140 560,180 T620,180 L620,300 Q590,340 560,300 T500,300 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M520,200 Q550,160 580,200 T640,200 L640,280 Q610,320 580,280 T520,280 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Asia */}
                <path
                  d="M640,80 Q670,40 700,80 T760,80 L760,240 Q730,280 700,240 T640,240 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M660,100 Q690,60 720,100 T780,100 L780,220 Q750,260 720,220 T660,220 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M680,120 Q710,80 740,120 T800,120 L800,200 Q770,240 740,200 T680,200 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M700,140 Q730,100 760,140 T820,140 L820,180 Q790,220 760,180 T700,180 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Australia */}
                <path
                  d="M780,320 Q810,280 840,320 T900,320 L900,380 Q870,420 840,380 T780,380 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                <path
                  d="M800,340 Q830,300 860,340 T920,340 L920,360 Q890,400 860,360 T800,360 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Greenland */}
                <path
                  d="M200,60 Q230,20 260,60 T320,60 L320,100 Q290,140 260,100 T200,100 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Japan */}
                <path
                  d="M820,140 Q850,100 880,140 T940,140 L940,160 Q910,200 880,160 T820,160 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* UK */}
                <path
                  d="M460,100 Q490,60 520,100 T580,100 L580,120 Q550,160 520,120 T460,120 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Madagascar */}
                <path
                  d="M520,280 Q550,240 580,280 T640,280 L640,300 Q610,340 580,300 T520,300 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* New Zealand */}
                <path
                  d="M820,380 Q850,340 880,380 T940,380 L940,400 Q910,440 880,400 T820,400 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
                ...
                {/* Iceland */}
                <path
                  d="M440,80 Q470,40 500,80 T560,80 L560,100 Q530,140 500,100 T440,100 Z"
                  fill="#4B5563"
                  opacity="0.15"
                />
              </svg>
