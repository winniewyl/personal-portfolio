      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        >
          <h2 className="text-3xl font-bold mb-10 text-violet-700 dark:text-violet-400">
            Internship a n d Professional Experience
          </h2>
        ...
        >
          ...
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-8 z-10">
              {/* Middle School */}
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center justify-center">
                <div className="w-20 h-20 mb-4 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/yu-hua-logo.png"
                    alt="江西育华学校 logo"
                ...
                <span className="font-bold text-lg text-violet-700 mt-2">
                  江西育华学校
                </span>
