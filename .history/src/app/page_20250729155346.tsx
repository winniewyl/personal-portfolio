          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-0">
            ...
            <div className="space-y-4 w-full">
              {projectData.map((proj, idx) => (
                <div
                  key={proj.title}
                  className="bg-white dark:bg-[#232336] rounded-xl shadow-lg overflow-hidden"
                >
                  {/* Accordion Header */}
                  <button
                    onClick={() => toggleProject(idx)}
                    className="w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 dark:hover:bg-[#2a2a3a] transition-colors"
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-md font-medium text-yellow-700 dark:text-yellow-300">
                        {proj.role}
                      </div>
                    </div>
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <svg
                        className={`w-6 h-6 text-yellow-600 transition-transform duration-300 ${
                          expandedProjects.includes(idx) ? 'rotate-180' : ''
                        }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
