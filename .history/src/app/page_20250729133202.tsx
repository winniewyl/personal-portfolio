          ...
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-0 z-10">
              ...
              <div className="group flex-1 w-72 h-72 relative -mr-12 transform rotate-3 hover:rotate-0 transition-all duration-300 perspective-1000">
                {/* Front Side - Logo */}
                <div className="absolute inset-0 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-6 border border-violet-100 dark:border-violet-700 text-center flex flex-col items-center justify-center backface-hidden group-hover:rotate-y-180 transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-6 border border-violet-100 dark:border-violet-700 text-center flex flex-col items-center justify-center backface-hidden rotate-y-180 group-hover:rotate-y-0 transition-transform duration-500">
              ...
              {/* High School */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-6 border border-violet-100 dark:border-violet-700 text-center relative -mr-12 transform -rotate-3 hover:rotate-0 hover:scale-105 transition-all duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/JXSDFZ-logo.png"
                    alt="江西师大附中国际部 logo"
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center space-y-1">
                  <span className="text-sm text-gray-700 dark:text-gray-300">
                    High School Diploma
                  </span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">
              ...
              {/* Tufts University */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-6 border border-violet-100 dark:border-violet-700 text-center relative -mr-12 transform rotate-5 hover:rotate-0 hover:scale-105 transition-all duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/tufts-logo.png"
              ...
              {/* Purdue University */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-6 border border-violet-100 dark:border-violet-700 text-center relative transform -rotate-5 hover:rotate-0 hover:scale-105 transition-all duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/purdue-logo.png"
