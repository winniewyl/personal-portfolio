        ...
        >
          ...
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-8 z-10">
              {/* Middle School */}
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center relative">
