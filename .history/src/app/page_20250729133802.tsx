      ...
      <footer className="w-full py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-8 flex flex-col items-center space-y-8">
          ...
          <div className="flex space-x-8">
            <a
              href="#"
              className="text-gray-800 dark:text-gray-200 hover:text-violet-600 transition-colors"
            >
          ...
          {/* Email Button */}
          <a
            href="mailto:wangyuling352@gmail.com"
            className="inline-block px-8 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full text-gray-900 dark:text-white font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          >
            EMAIL, PERHAPS?
          </a>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
            Featured on Bestfolios, Cofolios, Medium, and showcased at
            Facebook's 2020 Design Summit. Last updated January 2025.
          </p>
        </div>
      </footer>
    </div>
