        ...
        >
          ...
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-0 z-10">
              ...
              {/* High School */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-lg p-6 border border-violet-100 dark:border-violet-700 text-center relative -mr-8 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/JXSDFZ-logo.png"
                    alt="江西师大附中国际部 logo"
              ...
              {/* Tufts University */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-lg p-6 border border-violet-100 dark:border-violet-700 text-center relative -mr-8 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/tufts-logo.png"
              ...
              {/* Purdue University */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow-lg p-6 border border-violet-100 dark:border-violet-700 text-center relative transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                <div className="w-24 h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/purdue-logo.png"
