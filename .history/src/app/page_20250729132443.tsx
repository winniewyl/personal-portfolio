        ...
        >
          ...
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-0 z-10">
              ...
              {/* High School */}
              <div className="flex flex-col items-center flex-1 w-72 h-72 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center relative -mr-8">
                <div className="w-20 h-20 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/JXSDFZ-logo.png"
                    alt="江西师大附中国际部 logo"
