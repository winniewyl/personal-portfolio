          ...
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full flex flex-col lg:flex-row items-center justify-center">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-4 lg:gap-0">
                {/* Middle School */}
                <div
                  className="group flex-1 w-64 h-64 sm:w-72 sm:h-72 relative lg:-mr-12 transform rotate-3 hover:rotate-0 transition-all duration-300 perspective-1000"
                  data-flipped="false"
                >
                  {/* Front Side - Logo */}
                ...
                {/* High School */}
                <div className="group flex-1 w-64 h-64 sm:w-72 sm:h-72 relative lg:-mr-12 transform -rotate-3 hover:rotate-0 transition-all duration-300 perspective-1000">
                  {/* Front Side - Logo */}
                ...
                {/* Tufts University */}
                <div className="group flex-1 w-64 h-64 sm:w-72 sm:h-72 relative lg:-mr-12 transform rotate-5 hover:rotate-0 transition-all duration-300 perspective-1000">
                  {/* Front Side - Logo */}
                  <div className="absolute inset-0 bg-white dark:bg-[#232336] rounded-xl shadow-xl p-4 sm:p-6 border border-pink-100 dark:border-pink-700 text-center flex flex-col items-center justify-center backface-hidden group-hover:rotate-y-180 transition-transform duration-1000">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                      <img
