  ...
  return (
    <div className="font-sans min-h-screen flex flex-col">
      ...
      <nav className="w-full sticky top-0 z-10 bg-white/80 dark:bg-[#101010]/80 backdrop-blur border-b border-gray-100 dark:border-gray-800">
        <div className="w-full max-w-6xl mx-auto flex items-center justify-between py-4 sm:py-6">
          <div
            className={`text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight transition-colors duration-300 ${getNavbarColor()} cursor-pointer hover:opacity-80 pl-4 sm:pl-8`}
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
          >
            Winnie Wang
          </div>
          <ul className="flex gap-2 sm:gap-4 md:gap-8 text-sm sm:text-base font-medium pr-4 sm:pr-8">
            <li>
              <a
                href="#about"
