      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        >
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-center relative">
            {/* Purdue University */}
            <div className="flex flex-col items-center md:w-1/2 px-2 md:px-4 z-10 md:translate-y-4">
              <div className="flex flex-col items-center bg-white dark:bg-[#232336] rounded-xl shadow p-6 min-w-[260px] max-w-xs border border-violet-100 dark:border-violet-700">
            ...
            {/* Connector */}
            <div className="hidden md:block w-1/6 flex-shrink-0 relative h-32">
              <div className="absolute left-1/2 top-1/2 w-24 h-1 bg-violet-300 dark:bg-violet-700 transform -translate-x-1/2 -translate-y-1/2 rotate-12 rounded-full"></div>
