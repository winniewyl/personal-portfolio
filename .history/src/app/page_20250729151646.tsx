  ...
  return (
    <div className="font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        <section
          id="about"
          className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24 bg-blue-50 dark:bg-blue-900/20 min-h-screen"
        >
          <About />
        </section>
        {/* Experience Section */}
        <section
          id="experience"
          className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24 bg-green-50 dark:bg-green-900/20 min-h-screen"
        >
        ...
        <section
          id="projects"
          className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24 bg-yellow-50 dark:bg-yellow-900/20 min-h-screen"
        >
          <h2 className="text-3xl font-bold mb-10 text-violet-700 dark:text-violet-400">
        ...
        <section
          id="education"
          className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24 bg-pink-50 dark:bg-pink-900/20 min-h-screen"
        >
          <h2 className="text-3xl font-bold mb-10 text-violet-700 dark:text-violet-400">
            Education
          </h2>
