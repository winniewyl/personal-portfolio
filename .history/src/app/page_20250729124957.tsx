    ...
    <div className="font-sans min-h-screen flex flex-col bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-[#18181c] dark:via-[#1a1a22] dark:to-[#101014]">
      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        <section
          ...
          className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24"
        >
          <h2 className="text-3xl font-bold mb-10 text-violet-700 dark:text-violet-400"></h2>
        ...
        <section id="education" className="w-full flex flex-col items-center py-20 sm:py-28 max-w-5xl mx-auto scroll-mt-24">
          <h2 className="text-3xl font-bold mb-10 text-violet-700 dark:text-violet-400">Education</h2>
          <div className="relative w-full flex flex-col md:flex-row items-center justify-center">
            {/* Timeline SVG Connector */}
            <svg className="hidden md:block absolute left-0 right-0 top-1/2 -translate-y-1/2 z-0" height="120" width="100%" viewBox="0 0 1000 120" fill="none" preserveAspectRatio="none">
              <path d="M 80 60 Q 180 10, 280 60 T 480 60 T 680 60 T 880 60" stroke="#a78bfa" strokeWidth="4" fill="none" />
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full gap-8 z-10">
              {/* Middle School */}
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center justify-between">
                <div className="w-20 h-20 flex items-center justify-center rounded-full bg-white/30 backdrop-blur-md shadow-inner">
                  <img
                    src="/yu-hua-logo.png"
                    alt="江西育华学校 logo"
                ...
                <div className="flex flex-col items-center space-y-1">
                  <span className="font-bold text-lg text-violet-700">江西育华学校</span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">2014–2017</span>
                </div>
              ...
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center justify-between">
                ...
                <div className="flex flex-col items-center space-y-1">
                  <span className="font-bold text-lg text-violet-700">江西师大附中国际部</span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">High School Diploma</span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">2017–2020</span>
                </div>
                <div className="h-8"></div>
              </div>
              {/* Tufts University */}
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center justify-between">
                ...
                <div className="flex flex-col items-center space-y-1">
                  <span className="font-bold text-lg text-violet-700">Tufts University</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">May 2024</span>
                  <span className="text-gray-900 dark:text-white">B.S. in Applied Mathematics & Computer Science</span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">GPA: 3.83 / 4.00</span>
                  <span className="text-xs text-emerald-600 mt-1">Summa Cum Laude, Dean's List (all quarters)</span>
                </div>
                <div className="h-8"></div>
              </div>
              {/* Purdue University */}
              <div className="flex flex-col items-center flex-1 w-64 h-64 bg-white dark:bg-[#232336] rounded-xl shadow p-6 border border-violet-100 dark:border-violet-700 text-center justify-between">
                ...
                <div className="flex flex-col items-center space-y-1">
                  <span className="font-bold text-lg text-violet-700">Purdue University</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">Expected Jun 2026</span>
                  <span className="text-gray-900 dark:text-white">Master of Business and Technology</span>
                  <span className="text-sm text-gray-700 dark:text-gray-300">GPA: 3.75 / 4.00</span>
                </div>
                <div className="h-8"></div>
              </div>
            </div>
