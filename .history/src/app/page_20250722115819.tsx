      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        >
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-center relative">
            {/* Junior School */}
            <div className="flex flex-col items-center md:w-1/4 px-2 md:px-4 z-10 md:translate-y-6">
              <div className="flex flex-col items-center bg-white dark:bg-[#232336] rounded-xl shadow p-6 min-w-[200px] max-w-xs border border-violet-100 dark:border-violet-700">
            ...
            {/* Connector */}
            <div className="hidden md:block w-1/12 flex-shrink-0 relative h-32">
              <div className="absolute left-1/2 top-1/2 w-12 h-1 bg-violet-300 dark:bg-violet-700 transform -translate-x-1/2 -translate-y-1/2 rotate-12 rounded-full"></div>
              <div className="absolute left-1/2 top-1/2 w-4 h-4 bg-violet-400 dark:bg-violet-600 rounded-full border-4 border-white dark:border-[#18181c] shadow -translate-x-1/2 -translate-y-1/2"></div>
            </div>
            {/* High School */}
            <div className="flex flex-col items-center md:w-1/4 px-2 md:px-4 z-10 md:-translate-y-6">
              <div className="flex flex-col items-center bg-white dark:bg-[#232336] rounded-xl shadow p-6 min-w-[200px] max-w-xs border border-violet-100 dark:border-violet-700">
            ...
            {/* Purdue University */}
            <div className="flex flex-col items-center md:w-1/4 px-2 md:px-4 z-10 md:translate-y-4">
              <div className="flex flex-col items-center bg-white dark:bg-[#232336] rounded-xl shadow p-6 min-w-[200px] max-w-xs border border-violet-100 dark:border-violet-700">
                <span className="flex items-center justify-center w-10 h-10 bg-violet-100 rounded-full mb-2">
                  <svg
                    className="w-6 h-6 text-violet-600"
            ...
            <div className="flex flex-col items-center md:w-1/4 px-2 md:px-4 z-10 md:-translate-y-4">
              <div className="flex flex-col items-center bg-white dark:bg-[#232336] rounded-xl shadow p-6 min-w-[200px] max-w-xs border border-violet-100 dark:border-violet-700">
                ...
                <span className="text-gray-900 dark:text-white">
                  B.S. in Applied Mathematics & Computer Science (Double Major)
                </span>
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  GPA: 3.83 / 4.00
                </span>
