        ...
        >
          <div className="max-w-5xl mx-auto px-4 sm:px-0">
            ...
            <div className="relative w-full max-w-2xl mx-auto">
              ...
              <button
                onClick={prevProject}
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-white dark:bg-[#232336] rounded-full p-2 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
              ...
              <button
                onClick={nextProject}
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-white dark:bg-[#232336] rounded-full p-2 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
