  ...
  return (
    <div className="font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 sm:px-0">
        ...
        >
          <div className="max-w-300xl mx-auto px-4 sm:px-0">
            <About />
          </div>
        </section>
        {/* Experience Section */}
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-0">
            ...
            <div className="space-y-8">
              {experienceData.map((exp, idx) => (
                <div
                  key={exp.title}
                  className="bg-white dark:bg-[#232336] rounded-xl shadow-lg p-6 transform translate-y-8 opacity-0 animate-fade-in-up"
                  style={{
